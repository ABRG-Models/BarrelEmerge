...
# C3 whisker's epsilon was reduced from its original value of 1.2.
#
...
for logdirname in os.listdir(basedir):
    ...
    # Get the epsilon multiplier for C3 from the filename
    ...
    # Now the individual data. Trimmed barrel is C3, so barrels of interest are: B3, C2, C3, C4, D2, D3
...
import csv
with open('postproc/whisker_trim_overall.csv', 'w', newline='\n') as csvfile:
