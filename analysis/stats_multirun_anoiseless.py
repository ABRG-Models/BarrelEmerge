...
basedir = '/home/seb/gdrive_usfd/data/BarrelEmerge/multirun_anoiseless/'
t=30000
...
print ('honda_anoiseless = {0}'.format (hondas))
print ('etas_anoiseless = {0}'.format (eta))
print ('locns_anoiseless = {0}'.format (locns))
