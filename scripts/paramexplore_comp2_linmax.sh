...
#
# Filling in the gaps where the normal sim fails, especially as for
# F=0.48 and D<=0.12, the localization gets quite good.
            ...
            cat > configs/rat/paramexplore/${JSON} <<EOF
{
    ...
    "logevery": 5000,
    "overwrite_logs": true,
    "logbase" : "${HOME}/paramexplore_comp2_linmax/",
