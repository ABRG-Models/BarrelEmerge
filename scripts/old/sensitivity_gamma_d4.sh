...
CONFIG_DIR="configs/rat/sensitivity_gamma_d4"
...
# Barrel D4
for d4_gamma_i in -0.6 -0.3 0 0.3 0.6; do
        ...
        cat > ${CONFIG_DIR}/${JSON} <<EOF
{
    ...
    "logevery": 30000,
    "overwrite_logs": true,
    "logbase" : "/home/seb/gdrive_usfd/data/BarrelEmerge/sensitivity_gamma_d4/",
    ...
    "tc": [
        ...
        { "alpha" : ${ALPHA}, "beta" : ${BETA}, "xinit" : -0.16,   "yinit" : 0.0, "sigmainit" : 0.0, "gaininit" : 1.0, "gamma" : [${D4I}, ${D4J}], "name" : "D4" }, // D4
