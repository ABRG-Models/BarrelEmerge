...
CONFIG_DIR="configs/rat/sensitivity_gamma_c4"
...
# Barrel C4
for c4_gamma_i in -0.6 -0.3 0 0.3 0.6; do
    for c4_gamma_j in -0.6 -0.3 0 0.3 0.6; do

        # C4 normal gamma is: [0.004934757689654623, -0.07282464925911292]
        ((C4I=c4_gamma_i + 0.0049))
        ((C4J=c4_gamma_j - 0.0728))
        JSON="sa_gamma_c4_i${C4I}_j${C4J}.json"
        ...
        cat > ${CONFIG_DIR}/${JSON} <<EOF
{
    ...
    "tc": [
        ...
        { "alpha" : ${ALPHA}, "beta" : ${BETA}, "xinit" : -0.16,   "yinit" : 0.0, "sigmainit" : 0.0, "gaininit" : 1.0, "gamma" : [${C4I}, ${C4J}], "name" : "C4" }, // C4
