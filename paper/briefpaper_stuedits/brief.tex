...
\end{equation}
%
Accordingly, when the total density of connections sums to one, the density of thalamocortical connections decays at rate $\alpha$. Otherwise the synaptic connection density increases non-linearly ($l>1$) with the axon branching density. Changes in axon branching are modelled as 
%
...
The term in parentheses in Eq.~\ref{eq:dc} represents competition between thalamic projections for a limited availability of cortical connections. To introduce competition also in terms of axon branching we redefined
%
