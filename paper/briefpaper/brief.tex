...
(Eqs.~\ref{eq:dc}--\ref{eq:da}), ii) \cmnt{review} at each location the branching rate of a
given projection is reduced by the density of other projections
(Eq.\,\ref{eq:comp}), and iii)  \cmnt{review} the branch density of each projection is
