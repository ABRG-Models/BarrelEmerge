...
(see Fig.\,\ref{fig:main}D, squares). \cmnt{In a chosen region, the ratio of \emph{the connection density
  of the TC type $i$ which makes the densest connections} to \emph{the sum of all
...
(see Fig.\,\ref{fig:main}D, grey hexagons). $\omega$ increases during the first $20000$ simulation
steps and converges on a stable value. Fig.\,\ref{fig:main}E shows
