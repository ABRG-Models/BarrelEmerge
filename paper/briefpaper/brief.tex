...
\begin{center}
  ...
  \captionof{figure}{
    \MPthreePred{
      ...
      increased. \textbf{D} Individual barrel area plotted vs.~$m$ shows that
      as $m$ is reduced, the area of C3 (blue squares) goes down, disappearing
      for $m\approx0.5$, whereas the average area of neighbouring barrels
      (triangles) increases. Scale bars are 1\,mm.
    }
  }
  \label{fig:fgf8}
\end{center}
