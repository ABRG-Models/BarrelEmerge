...
\begin{center}
  \includegraphics[width=\linewidth]{./Fig4.png} \captionof{figure}{
    ...
    \citealp{kossut_effects_1992}. \MPthreePred{\textbf{D} The area of the C3
      barrel reduces as $m$ is reduced, whereas the mean area of neighbouring
      barrels (B3, C2, C4, D2 \& D3, grey circles) increases. The dotted grey
      line indicates $m=0.86$ for comparison with panel C.}}
  \label{fig:fgf8}
\end{center}
...
\MPthreePred{Finally, to investigate the response of the model to
  ...
  individual whiskers, or an entire row of whiskers leads to smaller
  barrels~\citep{kossut_effects_1992,loos_somatosensory_1973}. We simulated
  ...
  \citealp{kossut_effects_1992}, was obtained in simulation when $\epsilon$
