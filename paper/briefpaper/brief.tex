...
\begin{figure}
  \begin{fullwidth}
    ...
    \caption{\textbf{A} Left shows a cytochrome oxidase stain obtained from rat S1
      ...
      simulated barrel shapes, $\eta$ (the \cmnt{pattern quality metric---see
        Materials \& Methods; units mm$^3$});
      \cmnt{grey hexagons \stu{provide a measure of how selectively each
          cortical site is innervated} OR: show the measure of localization, $\omega =
      ...
      \textbf{E} \stu{Plotted across the cortical sheet, the selectivity
        ...
        shapes} OR: \cmnt{The localization measure plotted across the domain
...
\cmnt{First, we conducted 10 runs of the simulation shown in
  ...
  conditions for $a_i$) were $\delta=0.089\,(0.004)$, $\eta=113.5\textbf{!!}\,(1.2)$ and
...
\cmnt{Next, we modified the parameters of the generating uniform distribution
  ...
  $\eta=115\,(1.9)\textbf{!!}$ and $\omega=0.2166\,(0.0003)$. Paired two-sample t-tests
  ...
  $\eta: \mathrm{t}=-2.0,\mathrm{p}=0.06\textbf{!!}$,
  ...
  $\eta=114.31\textbf{!!}$ and $\omega=0.21649$) and that stochasticity in
