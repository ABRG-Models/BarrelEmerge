...
\significancestatement{The mystacial whiskers of the rat are a complex, ordered set of structures whose pattern is repeated several times in separate locations in the brain. We contribute a mechanism by which their spatially ordered pattern can be recreated in a self-organising process which requires minimal genetic pre-determination.}

\correspondingauthor{\textsuperscript{1}To whom correspondence should be addressed. E-mail: seb.james\@sheffield.ac.uk}
...
\dropcap{S}patial patterns in neural connectivity provide clues about
