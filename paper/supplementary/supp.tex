...
*: Ah, no sigmoid transfer function required. With $\bar{a}_i = a_i$ the
 system runs successfully, although for a limited parameter range. The system
 can be made slightly more stable by making
%
\begin{equation}
\begin{split}
\bar{a}_i & = a_i, a<a_{max} \\
          & = a_{max}, a\geq a_{max}
\end{split}
\end{equation}
